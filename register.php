...
<body>
    ...
    try {
        if (isset($_POST['register'])) {
            ...
            $query = mysqli_query($connection, "INSERT INTO tbl_user VALUES (null, '$nama', '$username', '$hashPassword', '$akses')");
    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="register.php"><img src="./assets/compiled/svg/logo.svg" alt="Logo" /></a>
                    </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <select class="form-control form-control-xl" name="akses" required>
